...
import FormRender from 'forms/ethers/EthersWalletGenerateMnemonicCard'
...
const mapDispatchToProps = (dispatch, props) => ({
  ethersWalletCreateFromMenemonicRequest: ()=>dispatch(ethersWalletCreateFromMenemonicRequest({
      metadata: {
        delta: 'WalletMnemonicGenerateRequest'
      }
    })),
